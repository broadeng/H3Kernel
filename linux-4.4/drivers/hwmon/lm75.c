...
static ssize_t show_id(struct device *dev, struct device_attribute *da,
		char *buf)
{
...
static ssize_t temp_show_reg(struct device *dev, struct device_attribute *da,
		char *buf)
{
	struct lm75_data *data = dev_get_drvdata(dev);
	struct i2c_client *client = data->client;
...
static ssize_t temp_set_reg(struct device *dev, struct device_attribute *da,
